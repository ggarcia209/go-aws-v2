...
func (e *ExprBuilder) SetFilter(name string, value any) {
...
func (e *ExprBuilder) BuildExpression() (Expression, error) {
	...
	build, err := eb.Build()
	if err != nil {
		return Expression{}, fmt.Errorf("eb.Build: %w", err)
	}
...
func (u *UpdateExpr) Add(name string, value any) {
...
func (u *UpdateExpr) Delete(name string, value any) {
...
func (u *UpdateExpr) SetIfNotExists(name string, value any) {
...
//
//	Ex: 'SET #name = #min + sub
func (u *UpdateExpr) SetPlus(name string, aug, add any, variable bool) {
	_, ok := aug.(string)
	if variable && ok {
...
//
//	Ex: 'SET #name = #min - sub
func (u *UpdateExpr) SetMinus(name string, min, sub any, variable bool) {
	_, ok := min.(string)
	if variable && ok {
...
func (u *UpdateExpr) SetListAppend(name string, list any) {
...
func (c *KeyConditions) Between(name string, lower, upper any) *KeyConditions {
...
func (c *KeyConditions) Equal(name string, value any) *KeyConditions {
...
func (c *KeyConditions) GreaterThan(name string, value any) *KeyConditions {
...
func (c *KeyConditions) GreaterThanEqual(name string, value any) *KeyConditions {
...
func (c *KeyConditions) LessThan(name string, value any) *KeyConditions {
...
func (c *KeyConditions) LessThanEqual(name string, value any) *KeyConditions {
...
func (c *Conditions) Between(name string, lower, upper any) {
...
func (c *Conditions) NotEqual(name string, value any) {
